import { createConversationHandler, getConversationHandler, listConversationHandler } from '@/controllers/conversation.controller';
...
conversationRouter.get('/', validateRequest({ query: listConversationQuerySchema }), listConversationHandler);
...
// conversationRouter.get('/:id/messages', validateRequest({ params: conversationIdParamsSchema, query: listMessagesQuerySchema }), listMessageHandler);
